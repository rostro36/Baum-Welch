...
plt.title('Different implementations icc')
...
plt.savefig('../final_plots/N-' +timestr+"-cycles-icc.png",dpi=200)
#plt.show()
plt.clf()

plt.xlabel('N')
plt.ylabel('cycles/iteration')
plt.title('Different implementations gcc')
plt.grid(which='minor', linestyle=':', linewidth='0.5', color='black')
...
figure.set_size_inches(8,4.5)
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-' +timestr+"-cycles-gcc.png",dpi=200)
#plt.show()
plt.clf()
...
plt.xlabel('N')
plt.ylabel('cycles/iteration')
plt.title('Different implementations icc vs. gcc')
plt.grid(which='minor', linestyle=':', linewidth='0.5', color='black')
...
style=1
for file in flags.keys():
    for flag in ['i-O2 -mfma','g-O2 -mfma']:
        #flag = 'g-O2 -mfma'
        plot_flag = flag
        x=[]
        y=[]
        for n in flags[file][flag]:
            ...
            if(file != 'vec'):
                plot_flag = re.sub('\ -mfma$','',flag)
        plt.plot(x,y, marker=markers[marker], color=comp_colors[color], linestyle=styles[style], label= file[:6]+': '+ compiler+' ' +str(plot_flag))
...
figure.set_size_inches(8,4.5)
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-' +timestr+"-cycles-compilers.png",dpi=200)
#plt.show()
plt.clf()

plt.xlabel('N')
plt.ylabel('cycles/iteration')
plt.title('Different implementations gcc -03 -march=native')
plt.grid(which='minor', linestyle=':', linewidth='0.5', color='black')
...
figure.set_size_inches(8,4.5)
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-' +timestr+"-cycles-march.png",dpi=200)
#plt.show()
plt.clf()
...
plt.xlabel('N')
plt.ylabel('cycles/iteration')
plt.title('Different implementations comparision flags')
plt.grid(which='minor', linestyle=':', linewidth='0.5', color='black')
...
figure.set_size_inches(8,4.5)
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-' +timestr+"-cycles-flags.png",dpi=200)
#plt.show()
plt.clf()
...
figure.set_size_inches(8,4.5)
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-' +timestr+"-perf-icc.png",dpi=200)
#plt.show()
plt.clf()
...
figure.set_size_inches(8,4.5)
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-' +timestr+"-perf-gcc.png",dpi=200)
#plt.show()
plt.clf()
...
plt.xlabel('N')
plt.ylabel('Performance [flops/cycle]')
plt.title('Different implementations comparision compiler')
plt.grid(which='minor', linestyle=':', linewidth='0.5', color='black')
...
figure.set_size_inches(8,4.5)
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-' +timestr+"-perf-compilers.png",dpi=200)
#plt.show()
plt.clf()
...
plt.xlabel('N')
plt.ylabel('Performance [flops/cycle]')
plt.title('Different implementations -O3 -march=native')
plt.grid(which='minor', linestyle=':', linewidth='0.5', color='black')
...
figure.set_size_inches(8,4.5)
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-' +timestr+"-perf-march.png",dpi=200)
#plt.show()
plt.clf()
...
figure.set_size_inches(8,4.5)
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-' +timestr+"-perf-flags.png",dpi=200)
#plt.show()
plt.clf()
...
#plt.show()
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-'+timestr+"-roof-icc.png",dpi=200)
plt.clf()
...
#plt.show()
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-'+timestr+"-roof-gcc.png",dpi=200)
plt.clf()
...
figure.set_size_inches(8,4.5)
plt.legend()
plt.title('Roofline Model compilers')
plt.xlabel('Operational Intensity [flops/byte]')
plt.ylabel('Performance [flops/cycle]')
...
#plt.show()
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-'+timestr+"-roof-compilers.png",dpi=200)
plt.clf()
...
figure.set_size_inches(8,4.5)
plt.legend()
plt.title('Roofline Model -O3 -march=native')
plt.xlabel('Operational Intensity [flops/byte]')
plt.ylabel('Performance [flops/cycle]')
...
#plt.show()
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-'+timestr+"-roof-march.png",dpi=200)
plt.clf()
...
figure.set_size_inches(8,4.5)
plt.legend()
plt.title('Roofline Model flags')
plt.xlabel('Operational Intensity [flops/byte]')
plt.ylabel('Performance [flops/cycle]')
...
#plt.show()
timestr = time.strftime("%d-%m_%H;%M")
plt.savefig('../final_plots/N-'+timestr+"-roof-flags.png",dpi=200)
plt.clf()
