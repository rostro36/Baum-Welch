...
int main(int argc, char *argv[]){
	...
	for (int run=0; run<maxRuns; run++){
        ...
        cycles= bw(transitionMatrix, emissionMatrix, stateProb, observations, gamma_sum, gamma_T, a_new, b_new, ct, hiddenStates, differentObservables, T, beta,	beta_new,alpha);
