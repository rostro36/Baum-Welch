		...
		for(int t = T-1; t > 0; t--){
			...
			for(int s = 0; s < hiddenStates ; s+=outer){
				...
				*/
				...
				__m256d beta_news4 = _mm256_setzero_pd();
				__m256d beta_news5 = _mm256_setzero_pd();
				__m256d beta_news6 = _mm256_setzero_pd();
				__m256d beta_news7 = _mm256_setzero_pd();
				...
				for(int j = 0; j < hiddenStates; j+=inner){
					...
					beta_news4 = _mm256_add_pd(beta_news4,temp4);
					beta_news5 = _mm256_add_pd(beta_news5,temp5);
					beta_news6 = _mm256_add_pd(beta_news6,temp6);
					beta_news7 = _mm256_add_pd(beta_news7,temp7);
				}
		...
		do{
			...
			for(int s = 0; s<hiddenStates; s+=outer){// s=new_state
				...
				*/
	        	...
	        	__m256d ctt_vec = _mm256_add_pd(ct0_vec0, ct0_vec4);
